...
{   
    ...
    b_info.board_type = ntohl(msg.board_info.board_type);
    b_info.master_slotid = (msg.board_info.master_slotid);
    ...
    printf("slot_id=%d, slot_type=%d, board_type=%x, uptime=%d, master_slotid=%d, hVer=%s, sVer=%s\n", 
            b_info.slot_id, 
            b_info.slot_type,
            b_info.board_type, 
            b_info.uptime,
